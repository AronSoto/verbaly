...
<p align="center">
  ...
  <a href="https://socket.dev/npm/package/verbaly"><img src="https://badge.socket.dev/npm/package/verbaly/0.16.0" alt="Socket supply chain security" /></a>
...
- **No proprietary format** — plain, portable JSON catalogs. No lock-in. Most TMS platforms ingest them natively, and `verbaly export`/`import` round-trips XLIFF 2.0 or CSV with human translators — imports are structure-validated, so a typo in a `{param}` or tag never reaches your UI.
