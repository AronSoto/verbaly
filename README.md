...
<p align="center">
  ...
  <a href="https://socket.dev/npm/package/verbaly"><img src="https://badge.socket.dev/npm/package/verbaly/0.62.0" alt="Socket supply chain security" /></a>
  ...
  <img src="https://img.shields.io/badge/gzip-3.19KB-3fb950" alt="3.19KB gzip runtime" />
...
**Verbaly inverts the flow.** You write the source text right in your code. A build plugin extracts the messages, generates **stable keys, types, and one module per locale**. So you get compiler-grade safety with a runtime of **3.19 KB gzip** and zero dependencies. That number is measured on every release by a gate in the repo, not estimated: `pnpm --filter verbaly size`.
...
| Runtime size (gzip)       | **3.19KB, zero deps** | 13.6KB (19.0 +react) | 2.2KB (3.3 +react)   | compiled       | 1.2KB         |
